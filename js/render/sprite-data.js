...
export const ART = {
  ...
  p_down1: { pal: P_PLAYER, px: [
    '....oooo....', '...occcco...', '..occcccco..', '..occddcco..',
    '..offffffo..', '..ofeffefo..', '..offffffo..', '...offffo...',
    '..ottuutto..', '..otttttto..', '..otttttto..', '..obbbbbbo..',
    '..oppppppo..', '..oppppppo..', '...osooso...', '...osooso...',
  ] },
  p_up0: { pal: P_PLAYER, px: [
  ...
  // ===== البلدة — town props =====
  crate: { pal: P_WOOD, solid: [1, 0, 14, 13], px: [
  ...
  pot: { pal: { o: OUT, g: '#b8863b', d: '#8a5a2c', l: '#d9a45a' }, solid: [2, 5, 12, 10], px: [
  ...
  barrel: { pal: { o: OUT, w: '#a8703c', d: '#8a5a2c', i: '#6a6a78' }, solid: [1, 0, 14, 18], px: [
  ...
  sack: { pal: { o: OUT, s: '#c9a45a', d: '#a8854a' }, solid: [2, 4, 12, 10], px: [
    '................', '......oooo......', '.....odooso.....', '.....ossoos.....',
  ...
  bench: { pal: P_WOOD, solid: [1, 4, 18, 7], px: [
    '....................', '....................', '..oooooooooooooooo..',
  ...
  chest_closed: { pal: { o: OUT, B: '#c98b3c', b: '#a8703c', G: '#d9a441', k: '#6a4426' }, solid: [1, 3, 14, 10], px: [
  ...
  chest_open: { pal: { o: OUT, B: '#c98b3c', b: '#a8703c', G: '#d9a441', k: '#6a4426', g: '#ffe9a8' }, solid: [1, 3, 14, 12], px: [
